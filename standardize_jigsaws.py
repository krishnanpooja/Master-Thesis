...
def define_and_process_args():
    ...
    parser.add_argument('--data_dir', default='C:\Users\Pooja\Desktop\4thSem\Thesis\dataset\Suturing\Suturing',
                        help='Data directory.')
    parser.add_argument('--data_filename', default='standardized_kinematic_data.pkl',
